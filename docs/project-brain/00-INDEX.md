...
> Última actualización: **2026-09-01** — costo de envío por zona en el checkout de la tienda: `shipping_cost` (resto del país) + `shipping_cost_tucuman_capital` + `shipping_cost_tucuman_interior`, provincia como `<select>` + selector de zona si es Tucumán; sin migración; rama `feature/checkout-envio-por-zona` sin mergear. Se actualizaron 02 (módulos 10 y 14), 03 (BR-STORE-012) y 10. Antes, el **2026-08-27** — "sección destacada / lanzamiento" genérica y reutilizable en la tienda (`/tienda/coleccion/:slug`, claves `store_collection_*`): landing propia editable desde el panel, sin migración; se actualizaron 02 (módulo 10), 09 y 10. Antes, el **2026-08-21** — refresco del pago desde el panel (sondeo del QR + botón Actualizar): se actualizaron 03, 06, 08 (DEC-021), 09 y 10. Antes, el **2026-08-19 (noche)** — pagos de MercadoPago del catálogo (acreditación real, métricas facturado≠cobrado, aviso automático): se actualizaron 03 (BR-CATALOG-001/002), 06, 08 (DEC-019, DEC-020), 09 (sección nueva) y 10. Antes, esa misma tarde, el cierre de la auditoría de panel actualizó 03, 06, 07, 08 (DEC-015 a DEC-018), 09, 10 y 11. El resto sigue siendo la fotografía del 2026-08-05.
