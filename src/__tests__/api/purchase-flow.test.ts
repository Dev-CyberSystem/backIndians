...
/*
 * Flujo de compra de punta a punta por API (pago por transferencia, no toca MercadoPago):
...
describe('Flujo de compra — API (transferencia)', () => {
  it('crea un pedido por transferencia y consulta su estado', async () => {
